...
public class StarTrekProgressBarUi extends BasicProgressBarUI {
    private static final float ONE_OVER_SEVEN = 1f / 7;
    private static final Color VIOLET = new Color(90, 0, 157);
    private static final Color DARCULA_COLOR = new Color(62, 65, 70);


    @SuppressWarnings({"MethodOverridesStaticMethodOfSuperclass", "UnusedDeclaration"})
    public static ComponentUI createUI(JComponent c) {
        c.setBorder(JBUI.Borders.empty().asUIResource());
        return new StarTrekProgressBarUi();
    }
    ...
    protected void paintIndeterminate(Graphics g2d, JComponent c) {
        ...
        LinearGradientPaint baseRainbowPaint = new LinearGradientPaint(0, JBUI.scale(2), 0, h - JBUI.scale(6),
                ...
                new Color[]{DARCULA_COLOR, Color.BLUE, DARCULA_COLOR, DARCULA_COLOR, DARCULA_COLOR, Color.BLUE, DARCULA_COLOR});
...
//        g.setPaint(baseRainbowPaint);
        ...
        Icon scaledIcon = velocity > 0 ? ((ScalableIcon) StarTrekIcons.CAT_ICON) : ((ScalableIcon) StarTrekIcons.RCAT_ICON) ;
//        if (velocity < 0) {
...
//        g2.setColor(progressBar.getForeground());
        ...
        StarTrekIcons.CAT_ICON.paintIcon(progressBar, g2, amountFull - JBUI.scale(10), -JBUI.scale(6));
