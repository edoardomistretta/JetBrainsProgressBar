...
public class JuventusProgressBarUi extends BasicProgressBarUI {
    ...
    public static ComponentUI createUI(JComponent c) {
        ...
        return new JuventusProgressBarUi();
    }
    ...
    protected void paintIndeterminate(Graphics g2d, JComponent c) {
        ...
        LinearGradientPaint baseRainbowPaint = new LinearGradientPaint(0, JBUI.scale(2), 0, h - JBUI.scale(6),
                ...
                new Color[]{Color.BLACK, Color.WHITE, Color.BLACK, Color.WHITE, Color.BLACK, Color.WHITE, Color.BLACK});
...
//        g.setPaint(baseRainbowPaint);
        ...
        Icon scaledIcon = velocity > 0 ? ((ScalableIcon) JuventusIcons.CAT_ICON) : ((ScalableIcon) JuventusIcons.RCAT_ICON) ;
//        if (velocity < 0) {
...
//        g2.setColor(progressBar.getForeground());
        ...
        JuventusIcons.CAT_ICON.paintIcon(progressBar, g2, amountFull - JBUI.scale(10), -JBUI.scale(6));
