...
public class FacileItProgressBarUi extends BasicProgressBarUI {
    private static final float ONE_OVER_SEVEN = 1f / 7;
    private static final Color TRANSPARENT = new Color(255, 255, 255, 1);


    @SuppressWarnings({"MethodOverridesStaticMethodOfSuperclass", "UnusedDeclaration"})
    public static ComponentUI createUI(JComponent c) {
        c.setBorder(JBUI.Borders.empty().asUIResource());
        return new FacileItProgressBarUi();
    }
    ...
    protected void paintIndeterminate(Graphics g2d, JComponent c) {
        ...
        LinearGradientPaint baseRainbowPaint = new LinearGradientPaint(0, JBUI.scale(2), 0, h - JBUI.scale(6),
                ...
                new Color[]{TRANSPARENT, TRANSPARENT, TRANSPARENT, TRANSPARENT, TRANSPARENT, TRANSPARENT, TRANSPARENT});
...
//        g.setPaint(baseRainbowPaint);
        ...
        Icon scaledIcon = velocity > 0 ? ((ScalableIcon) FacileItIcons.CAT_ICON) : ((ScalableIcon) FacileItIcons.RCAT_ICON) ;
//        if (velocity < 0) {
...
//        g2.setColor(progressBar.getForeground());
        ...
        FacileItIcons.CAT_ICON.paintIcon(progressBar, g2, amountFull - JBUI.scale(10), -JBUI.scale(6));
